...
/**
 * Servlet implementation class LibrosControllers
 */
@WebServlet("/LibrosControllers.do")
public class LibrosControllers extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("Site/Libros.jsp").forward(request, response);
